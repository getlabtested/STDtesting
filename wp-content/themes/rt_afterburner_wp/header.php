...
<script type="text/javascript" src="tabsJs/simpletabs_1.3.js"></script>
<script type="text/javascript" src="js/std-testing-options.js"></script>
	...
	<body>
		...
		<div id="main">
			<div id="wrapper" class="foreground">
				...
				<div id="nav">
		    		<?php if(get_post_meta($post->ID, 'no_nav', true) == ''){
