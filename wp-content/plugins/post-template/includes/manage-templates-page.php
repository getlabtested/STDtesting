...
<div id="message" class="updated fade">
	...
	<?php 
		...
		if ($template->type=='page') { ?>
			<a href="post-new.php?page=post-template/includes/edit-page-template-page.php&template_id=<?php echo $new_template_id; ?>"><?php _e('Edit this template', POST_TEMPLATES_I18N_DOMAIN); ?></a>	
	<?php 
		} else { 
	?>
			<a href="post-new.php?page=post-template/includes/edit-post-template-page.php&template_id=<?php echo $new_template_id; ?>"><?php _e('Edit this template', POST_TEMPLATES_I18N_DOMAIN); ?></a>
	<?php 
		} 
	?>
	</p>
...
?>
<br class="clear" />
<span class="button-secondary"><a href="<?php echo get_option('siteurl'); ?>/wp-admin/post-new.php?page=post-template/includes/edit-post-template-page.php" style="text-decoration: none;"><?php _e("Create Post Template", POST_TEMPLATES_I18N_DOMAIN); ?> &raquo;</a></span> 
<span class="button-secondary"><a href="<?php echo get_option('siteurl'); ?>/wp-admin/post-new.php?page=post-template/includes/edit-page-template-page.php" style="text-decoration: none;"><?php _e("Create Page Template", POST_TEMPLATES_I18N_DOMAIN); ?> &raquo;</a></span>
<br class="clear" />
<?php
	}
?>
...
?>
	<tr>
		...
		<td scope="row" style="text-align: left">
			<?php 
				if ($template->type=='post') {
					$link = "post-new.php?page=post-template/includes/edit-post-template-page.php&template_id=" . $template->template_id;
				} else {
					$link = "post-new.php?page=post-template/includes/edit-page-template-page.php&template_id=" . $template->template_id;					
				}
