...
function submitPaymentForm()
{
    ...
    if (payOptVal == 'now')
    {
           ...
           var stripped = cvv2.replace(/[\(\)\.\-\ ]/g, '');
    	     if (isNaN(parseInt(stripped)) || stripped.length > 4 || stripped.length < 3) 
    		  {
...
{   
	...
	theForm = document.orderfrm;
	var posResultVal = theForm.posRslt.options[theForm.posRslt.selectedIndex].value;
  tbl = document.getElementById('phoneNumTbl');
	
	if (posResultVal == "email") 
	{
